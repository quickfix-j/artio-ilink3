...
public final class ExecutionReportReject523Decoder implements MessageDecoderFlyweight
{
    public static final int BLOCK_LENGTH = 483;
    public static final int TEMPLATE_ID = 523;
    public static final int SCHEMA_ID = 8;
    public static final int SCHEMA_VERSION = 8;
    public static final String SEMANTIC_VERSION = "FIX5.0";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final ExecutionReportReject523Decoder parentMessage = this;
    ...
    public ExecutionReportReject523Decoder wrap(
    ...
    public ExecutionReportReject523Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExecutionReportReject523Decoder sbeRewind()
    {
    ...
    public byte location(final int index)
    {
        ...
        final int pos = offset + 420 + (index * 1);
    ...
    public int getLocation(final byte[] dst, final int dstOffset)
    {
        ...
        buffer.getBytes(offset + 420, dst, dstOffset, length);
    ...
    public String location()
    {
        ...
        buffer.getBytes(offset + 420, dst, 0, 5);
    ...
    public int getLocation(final Appendable value)
    {
        for (int i = 0; i < 5; ++i)
        {
            final int c = buffer.getByte(offset + 420 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    {
        return buffer.getInt(offset + 425, BYTE_ORDER);
    }
    ...
    {
        return (buffer.getInt(offset + 429, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    public long minQty()
    {
        return (buffer.getInt(offset + 433, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    {
        return (buffer.getInt(offset + 437, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    {
        return (buffer.getShort(offset + 441, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return (buffer.getShort(offset + 443, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return (buffer.getShort(offset + 445, BYTE_ORDER) & 0xFFFF);
    }
    ...
    private static final byte[] ORDSTATUS_VALUE = { 56 };
    ...
    private static final byte[] EXECTYPE_VALUE = { 56 };
    ...
    {
        return buffer.getByte(offset + 447);
    }

    public OrderType ordType()
    {
        return OrderType.get(buffer.getByte(offset + 447));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 448) & 0xFF));
    }

    public SideReq side()
    {
        return SideReq.get(((short)(buffer.getByte(offset + 448) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 449) & 0xFF));
    }

    public TimeInForce timeInForce()
    {
        return TimeInForce.get(((short)(buffer.getByte(offset + 449) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 450) & 0xFF));
    }

    public ManualOrdIndReq manualOrderIndicator()
    {
        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 450) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 451) & 0xFF));
    }

    public BooleanFlag possRetransFlag()
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 451) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 452) & 0xFF));
    }

    public SplitMsg splitMsg()
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 452) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 453) & 0xFF));
    }
    ...
    {
        execInst.wrap(buffer, offset + 454);
        return execInst;
    }
    ...
    {
        return buffer.getByte(offset + 455);
    }

    public ExecMode executionMode()
    {
        return ExecMode.get(buffer.getByte(offset + 455));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 456) & 0xFF));
    }

    public BooleanNULL liquidityFlag()
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 456) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 457) & 0xFF));
    }

    public BooleanNULL managedOrder()
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 457) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 458) & 0xFF));
    }

    public ShortSaleType shortSaleType()
    {
        return ShortSaleType.get(((short)(buffer.getByte(offset + 458) & 0xFF)));
    }
    ...
    public long delayToTime()
    {
        ...
        return buffer.getLong(offset + 459, BYTE_ORDER);
    }
    ...
    public PRICENULL9Decoder discretionPrice()
    {
        ...
        discretionPrice.wrap(buffer, offset + 467);
    ...
    public PRICENULL9Decoder reservationPrice()
    {
        ...
        reservationPrice.wrap(buffer, offset + 475);
    ...
    public String toString()
    {
        ...
        final ExecutionReportReject523Decoder decoder = new ExecutionReportReject523Decoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ExecutionReportReject523](sbeTemplateId=");
        ...
        builder.append(this.ordRejReason());
        builder.append('|');
    ...
    public ExecutionReportReject523Decoder sbeSkip()
    {
        sbeRewind();
