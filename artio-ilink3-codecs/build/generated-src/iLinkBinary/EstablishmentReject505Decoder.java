...
public final class EstablishmentReject505Decoder implements MessageDecoderFlyweight
{
    ...
    private final EstablishmentReject505Decoder parentMessage = this;
    ...
    public EstablishmentReject505Decoder wrap(
    ...
    public EstablishmentReject505Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public EstablishmentReject505Decoder sbeRewind()
    {
    ...
    {
        return (buffer.getInt(offset + 64, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    {
        return (buffer.getShort(offset + 68, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return FTI.get(((short)(buffer.getByte(offset + 70) & 0xFF)));
    }
    ...
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 71) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[EstablishmentReject505](sbeTemplateId=");
    ...
    public EstablishmentReject505Decoder sbeSkip()
    {
        sbeRewind();
