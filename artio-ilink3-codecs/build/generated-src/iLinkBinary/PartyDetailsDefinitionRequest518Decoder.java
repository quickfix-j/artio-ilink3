...
public final class PartyDetailsDefinitionRequest518Decoder implements MessageDecoderFlyweight
{
    ...
    private final PartyDetailsDefinitionRequest518Decoder parentMessage = this;
    ...
    public PartyDetailsDefinitionRequest518Decoder wrap(
    ...
    public PartyDetailsDefinitionRequest518Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public PartyDetailsDefinitionRequest518Decoder sbeRewind()
    {
    ...
    {
        return ListUpdAct.get(buffer.getByte(offset + 16));
    }
    ...
    public String memo()
    {
        ...
        buffer.getBytes(offset + 21, dst, 0, 75);
    ...
    public String avgPxGroupID()
    {
        ...
        buffer.getBytes(offset + 96, dst, 0, 20);
    ...
    public int getAvgPxGroupID(final Appendable value)
    {
        for (int i = 0; i < 20; ++i)
        {
            final int c = buffer.getByte(offset + 96 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    {
        return CmtaGiveUpCD.get(buffer.getByte(offset + 124));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 125) & 0xFF));
    }

    public CustOrderCapacity custOrderCapacity()
    {
        return CustOrderCapacity.get(((short)(buffer.getByte(offset + 125) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 126) & 0xFF));
    }

    public ClearingAcctType clearingAccountType()
    {
        return ClearingAcctType.get(((short)(buffer.getByte(offset + 126) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 127);
    }

    public SMPI selfMatchPreventionInstruction()
    {
        return SMPI.get(buffer.getByte(offset + 127));
    }
    ...
    {
        return AvgPxInd.get(((short)(buffer.getByte(offset + 128) & 0xFF)));
    }
    ...
    {
        return SLEDS.get(((short)(buffer.getByte(offset + 129) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 130);
    }

    public CustOrdHandlInst custOrderHandlingInst()
    {
        return CustOrdHandlInst.get(buffer.getByte(offset + 130));
    }
    ...
    {
        return buffer.getLong(offset + 131, BYTE_ORDER);
    }
    ...
    {
        return buffer.getLong(offset + 139, BYTE_ORDER);
    }
        ...
        implements Iterable<NoPartyDetailsDecoder>, java.util.Iterator<NoPartyDetailsDecoder>
    {
        ...
        private final PartyDetailsDefinitionRequest518Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoPartyDetailsDecoder(final PartyDetailsDefinitionRequest518Decoder parentMessage)
        {
        ...
        implements Iterable<NoTrdRegPublicationsDecoder>, java.util.Iterator<NoTrdRegPublicationsDecoder>
    {
        ...
        NoTrdRegPublicationsDecoder(final PartyDetailsDefinitionRequest518Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[PartyDetailsDefinitionRequest518](sbeTemplateId=");
    ...
    public PartyDetailsDefinitionRequest518Decoder sbeSkip()
    {
        sbeRewind();
