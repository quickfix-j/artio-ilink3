...
public final class PartyDetailsDefinitionRequestAck519Encoder implements MessageEncoderFlyweight
{
    ...
    private final PartyDetailsDefinitionRequestAck519Encoder parentMessage = this;
    ...
    public PartyDetailsDefinitionRequestAck519Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder wrapAndApplyHeader(
    ...
    public PartyDetailsDefinitionRequestAck519Encoder seqNum(final long value)
    {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder uUID(final long value)
    {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder memo(final int index, final byte value)
    {
        if (index < 0 || index >= 75)
        {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder putMemo(final byte[] src, final int srcOffset)
    {
        final int length = 75;
    ...
    public PartyDetailsDefinitionRequestAck519Encoder memo(final String src)
    {
        final int length = 75;
    ...
    public PartyDetailsDefinitionRequestAck519Encoder memo(final CharSequence src)
    {
        final int length = 75;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public PartyDetailsDefinitionRequestAck519Encoder avgPxGroupID(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public PartyDetailsDefinitionRequestAck519Encoder putAvgPxGroupID(final byte[] src, final int srcOffset)
    {
        final int length = 20;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder avgPxGroupID(final String src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
        ...
        buffer.putStringWithoutLengthAscii(offset + 87, src);
    ...
    public PartyDetailsDefinitionRequestAck519Encoder avgPxGroupID(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public PartyDetailsDefinitionRequestAck519Encoder partyDetailsListReqID(final long value)
    {
        buffer.putLong(offset + 107, value, BYTE_ORDER);
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder sendingTimeEpoch(final long value)
    {
        buffer.putLong(offset + 115, value, BYTE_ORDER);
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder selfMatchPreventionID(final long value)
    {
        buffer.putLong(offset + 123, value, BYTE_ORDER);
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder partyDetailRequestStatus(final short value)
    {
        buffer.putByte(offset + 131, (byte)value);
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder custOrderCapacity(final CustOrderCapacity value)
    {
        buffer.putByte(offset + 132, (byte)value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder clearingAccountType(final ClearingAcctType value)
    {
        buffer.putByte(offset + 133, (byte)value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder selfMatchPreventionInstruction(final SMPI value)
    {
        buffer.putByte(offset + 134, value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder avgPxIndicator(final AvgPxInd value)
    {
        buffer.putByte(offset + 135, (byte)value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder clearingTradePriceType(final SLEDS value)
    {
        buffer.putByte(offset + 136, (byte)value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder cmtaGiveupCD(final CmtaGiveUpCD value)
    {
        buffer.putByte(offset + 137, value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder custOrderHandlingInst(final CustOrdHandlInst value)
    {
        buffer.putByte(offset + 138, value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder listUpdateAction(final ListUpdAct value)
    {
        buffer.putByte(offset + 139, value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder partyDetailDefinitionStatus(final short value)
    {
        buffer.putByte(offset + 140, (byte)value);
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder executor(final long value)
    {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder iDMShortCode(final long value)
    {
    ...
    public PartyDetailsDefinitionRequestAck519Encoder possRetransFlag(final BooleanFlag value)
    {
        buffer.putByte(offset + 157, (byte)value.value());
        return this;
    }
    ...
    public PartyDetailsDefinitionRequestAck519Encoder splitMsg(final SplitMsg value)
    {
    ...
    public static final class NoPartyDetailsEncoder
    {
        ...
        private final PartyDetailsDefinitionRequestAck519Encoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoPartyDetailsEncoder(final PartyDetailsDefinitionRequestAck519Encoder parentMessage)
        {
    ...
    public static final class NoTrdRegPublicationsEncoder
    {
        ...
        NoTrdRegPublicationsEncoder(final PartyDetailsDefinitionRequestAck519Encoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
