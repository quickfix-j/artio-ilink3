...
public final class ExecutionReportNew522Decoder implements MessageDecoderFlyweight
{
    ...
    private final ExecutionReportNew522Decoder parentMessage = this;
    ...
    public ExecutionReportNew522Decoder wrap(
    ...
    public ExecutionReportNew522Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExecutionReportNew522Decoder sbeRewind()
    {
    ...
    {
        return (buffer.getShort(offset + 185, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return (buffer.getShort(offset + 187, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return buffer.getByte(offset + 189);
    }

    public OrderType ordType()
    {
        return OrderType.get(buffer.getByte(offset + 189));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 190) & 0xFF));
    }

    public SideReq side()
    {
        return SideReq.get(((short)(buffer.getByte(offset + 190) & 0xFF)));
    }
    ...
    {
        return TimeInForce.get(((short)(buffer.getByte(offset + 191) & 0xFF)));
    }
    ...
    {
        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 192) & 0xFF)));
    }
    ...
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 193) & 0xFF)));
    }
    ...
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 194) & 0xFF)));
    }
    ...
    {
        return ExecMode.get(buffer.getByte(offset + 197));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 198) & 0xFF)));
    }
    ...
    {
        return ShortSaleType.get(((short)(buffer.getByte(offset + 200) & 0xFF)));
    }
    ...
    public long delayToTime()
    {
        ...
        return buffer.getLong(offset + 201, BYTE_ORDER);
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ExecutionReportNew522](sbeTemplateId=");
    ...
    public ExecutionReportNew522Decoder sbeSkip()
    {
        sbeRewind();
