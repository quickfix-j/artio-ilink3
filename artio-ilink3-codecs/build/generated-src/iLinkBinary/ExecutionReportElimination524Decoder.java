...
public final class ExecutionReportElimination524Decoder implements MessageDecoderFlyweight
{
    ...
    private final ExecutionReportElimination524Decoder parentMessage = this;
    ...
    public ExecutionReportElimination524Decoder wrap(
    ...
    public ExecutionReportElimination524Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExecutionReportElimination524Decoder sbeRewind()
    {
    ...
    {
        return buffer.getByte(offset + 191);
    }

    public OrderType ordType()
    {
        return OrderType.get(buffer.getByte(offset + 191));
    }
    ...
    public SideReq side()
    {
        return SideReq.get(((short)(buffer.getByte(offset + 192) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 193) & 0xFF));
    }

    public TimeInForce timeInForce()
    {
        return TimeInForce.get(((short)(buffer.getByte(offset + 193) & 0xFF)));
    }
    ...
    {
        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 194) & 0xFF)));
    }
    ...
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 195) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 198);
    }

    public ExecMode executionMode()
    {
        return ExecMode.get(buffer.getByte(offset + 198));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 199) & 0xFF)));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 200) & 0xFF)));
    }
    ...
    {
        return ShortSaleType.get(((short)(buffer.getByte(offset + 201) & 0xFF)));
    }
    ...
    public short priorityIndicator()
    {
        ...
        return ((short)(buffer.getByte(offset + 218) & 0xFF));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ExecutionReportElimination524](sbeTemplateId=");
    ...
    public ExecutionReportElimination524Decoder sbeSkip()
    {
        sbeRewind();
