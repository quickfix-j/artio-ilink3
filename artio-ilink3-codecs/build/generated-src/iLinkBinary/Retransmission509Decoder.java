...
public final class Retransmission509Decoder implements MessageDecoderFlyweight
{
    ...
    private final Retransmission509Decoder parentMessage = this;
    ...
    public Retransmission509Decoder wrap(
    ...
    public Retransmission509Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public Retransmission509Decoder sbeRewind()
    {
    ...
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 30) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[Retransmission509](sbeTemplateId=");
    ...
    public Retransmission509Decoder sbeSkip()
    {
        sbeRewind();
