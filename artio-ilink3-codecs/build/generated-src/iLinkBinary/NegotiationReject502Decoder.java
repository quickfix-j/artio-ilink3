...
public final class NegotiationReject502Decoder implements MessageDecoderFlyweight
{
    ...
    private final NegotiationReject502Decoder parentMessage = this;
    ...
    public NegotiationReject502Decoder wrap(
    ...
    public NegotiationReject502Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public NegotiationReject502Decoder sbeRewind()
    {
    ...
    {
        return FTI.get(((short)(buffer.getByte(offset + 66) & 0xFF)));
    }
    ...
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 67) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[NegotiationReject502](sbeTemplateId=");
    ...
    public NegotiationReject502Decoder sbeSkip()
    {
        sbeRewind();
