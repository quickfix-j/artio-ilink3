...
public final class ExecutionReportTradeAddendumOutright548Decoder implements MessageDecoderFlyweight
{
    ...
    private final ExecutionReportTradeAddendumOutright548Decoder parentMessage = this;
    ...
    public ExecutionReportTradeAddendumOutright548Decoder wrap(
    ...
    public ExecutionReportTradeAddendumOutright548Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExecutionReportTradeAddendumOutright548Decoder sbeRewind()
    {
    ...
    public SideReq side()
    {
        return SideReq.get(((short)(buffer.getByte(offset + 173) & 0xFF)));
    }
    ...
    {
        return ExecMode.get(buffer.getByte(offset + 177));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 178) & 0xFF)));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 179) & 0xFF)));
    }
    ...
    {
        return ShortSaleType.get(((short)(buffer.getByte(offset + 180) & 0xFF)));
    }
    ...
    public ExecReason execRestatementReason()
    {
        ...
        return ExecReason.get(((short)(buffer.getByte(offset + 191) & 0xFF)));
    }
    ...
    public int settlDate()
    {
        ...
        return (buffer.getShort(offset + 192, BYTE_ORDER) & 0xFFFF);
    }
    ...
    public int maturityDate()
    {
        ...
        return (buffer.getShort(offset + 194, BYTE_ORDER) & 0xFFFF);
    }
        ...
        implements Iterable<NoFillsDecoder>, java.util.Iterator<NoFillsDecoder>
    {
        ...
        private final ExecutionReportTradeAddendumOutright548Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoFillsDecoder(final ExecutionReportTradeAddendumOutright548Decoder parentMessage)
        {
        ...
        implements Iterable<NoOrderEventsDecoder>, java.util.Iterator<NoOrderEventsDecoder>
    {
        ...
        NoOrderEventsDecoder(final ExecutionReportTradeAddendumOutright548Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ExecutionReportTradeAddendumOutright548](sbeTemplateId=");
    ...
    public ExecutionReportTradeAddendumOutright548Decoder sbeSkip()
    {
        sbeRewind();
