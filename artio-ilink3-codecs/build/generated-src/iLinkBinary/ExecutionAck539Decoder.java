...
public final class ExecutionAck539Decoder implements MessageDecoderFlyweight
{
    ...
    private final ExecutionAck539Decoder parentMessage = this;
    ...
    public ExecutionAck539Decoder wrap(
    ...
    public ExecutionAck539Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExecutionAck539Decoder sbeRewind()
    {
    ...
    {
        return ExecAckStatus.get(((short)(buffer.getByte(offset + 16) & 0xFF)));
    }
     ...
     * Price of this fill
     *
     * @return PRICE9Decoder : Price of this fill
     */
    ...
    {
        return buffer.getInt(offset + 57, BYTE_ORDER);
    }
    ...
    public long lastQty()
    {
        return (buffer.getInt(offset + 61, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    {
        return DKReason.get(buffer.getByte(offset + 65));
    }
    ...
    public SideReq side()
    {
        return SideReq.get(((short)(buffer.getByte(offset + 66) & 0xFF)));
    }
    ...
    public String senderID()
    {
        ...
        final byte[] dst = new byte[20];
        buffer.getBytes(offset + 67, dst, 0, 20);
    ...
    public int getSenderID(final Appendable value)
    {
        ...
        for (int i = 0; i < 20; ++i)
        {
            final int c = buffer.getByte(offset + 67 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    public String location()
    {
        ...
        buffer.getBytes(offset + 95, dst, 0, 5);
    ...
    public int getLocation(final Appendable value)
    {
        ...
        for (int i = 0; i < 5; ++i)
        {
            final int c = buffer.getByte(offset + 95 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    public ManualOrdIndReq manualOrderIndicator()
    {
        if (parentMessage.actingVersion < 5)
        {
            return ManualOrdIndReq.NULL_VAL;
        }

        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 100) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ExecutionAck539](sbeTemplateId=");
        ...
        builder.append(this.execAckStatus());
        builder.append('|');
    ...
    public ExecutionAck539Decoder sbeSkip()
    {
        sbeRewind();
