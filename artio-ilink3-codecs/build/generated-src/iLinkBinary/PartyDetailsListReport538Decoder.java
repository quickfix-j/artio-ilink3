...
public final class PartyDetailsListReport538Decoder implements MessageDecoderFlyweight
{
    ...
    private final PartyDetailsListReport538Decoder parentMessage = this;
    ...
    public PartyDetailsListReport538Decoder wrap(
    ...
    public PartyDetailsListReport538Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public PartyDetailsListReport538Decoder sbeRewind()
    {
    ...
    public long partyDetailsListReportID()
    {
    ...
    public short requestResultRaw()
    {
        return ((short)(buffer.getByte(offset + 66) & 0xFF));
    }

    public ReqResult requestResult()
    {
        return ReqResult.get(((short)(buffer.getByte(offset + 66) & 0xFF)));
    }
    ...
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 67) & 0xFF)));
    }
    ...
    {
        return CustOrderCapacity.get(((short)(buffer.getByte(offset + 68) & 0xFF)));
    }
    ...
    {
        return ClearingAcctType.get(((short)(buffer.getByte(offset + 69) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 70);
    }

    public SMPI selfMatchPreventionInstruction()
    {
        return SMPI.get(buffer.getByte(offset + 70));
    }
    ...
    {
        return AvgPxInd.get(((short)(buffer.getByte(offset + 71) & 0xFF)));
    }
    ...
    {
        return SLEDS.get(((short)(buffer.getByte(offset + 72) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 73);
    }

    public CmtaGiveUpCD cmtaGiveupCD()
    {
        return CmtaGiveUpCD.get(buffer.getByte(offset + 73));
    }
    ...
    {
        return CustOrdHandlInst.get(buffer.getByte(offset + 74));
    }
    ...
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 91) & 0xFF)));
    }
    ...
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 92) & 0xFF)));
    }
        ...
        implements Iterable<NoPartyDetailsDecoder>, java.util.Iterator<NoPartyDetailsDecoder>
    {
        ...
        private final PartyDetailsListReport538Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        NoPartyDetailsDecoder(final PartyDetailsListReport538Decoder parentMessage)
        {
        ...
        implements Iterable<NoTrdRegPublicationsDecoder>, java.util.Iterator<NoTrdRegPublicationsDecoder>
    {
        ...
        NoTrdRegPublicationsDecoder(final PartyDetailsListReport538Decoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[PartyDetailsListReport538](sbeTemplateId=");
        ...
        builder.append('|');
        builder.append("partyDetailsListReportID=");
        builder.append(this.partyDetailsListReportID());
        builder.append('|');
        ...
        builder.append('|');
        builder.append("totNumParties=");
        builder.append(this.totNumParties());
        builder.append('|');
        builder.append("requestResult=");
        builder.append(this.requestResult());
        builder.append('|');
    ...
    public PartyDetailsListReport538Decoder sbeSkip()
    {
        sbeRewind();
