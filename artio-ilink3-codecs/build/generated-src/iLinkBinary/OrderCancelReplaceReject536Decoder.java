...
public final class OrderCancelReplaceReject536Decoder implements MessageDecoderFlyweight
{
    ...
    private final OrderCancelReplaceReject536Decoder parentMessage = this;
    ...
    public OrderCancelReplaceReject536Decoder wrap(
    ...
    public OrderCancelReplaceReject536Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderCancelReplaceReject536Decoder sbeRewind()
    {
    ...
    {
        return buffer.getLong(offset + 364, BYTE_ORDER);
    }
    ...
    {
        return buffer.getLong(offset + 372, BYTE_ORDER);
    }
    ...
    public int getLocation(final byte[] dst, final int dstOffset)
    {
        ...
        buffer.getBytes(offset + 388, dst, dstOffset, length);
    ...
    public String location()
    {
        ...
        buffer.getBytes(offset + 388, dst, 0, 5);
    ...
    public int getLocation(final Appendable value)
    {
        for (int i = 0; i < 5; ++i)
        {
            final int c = buffer.getByte(offset + 388 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    {
        return (buffer.getShort(offset + 393, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return (buffer.getShort(offset + 395, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 397) & 0xFF));
    }

    public ManualOrdIndReq manualOrderIndicator()
    {
        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 397) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 398) & 0xFF));
    }

    public BooleanFlag possRetransFlag()
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 398) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 399) & 0xFF));
    }

    public SplitMsg splitMsg()
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 399) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 400) & 0xFF));
    }

    public BooleanNULL liquidityFlag()
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 400) & 0xFF)));
    }
    ...
    public long delayToTime()
    {
        ...
        return buffer.getLong(offset + 401, BYTE_ORDER);
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[OrderCancelReplaceReject536](sbeTemplateId=");
        ...
        builder.append(this.cxlRejReason());
        builder.append('|');
    ...
    public OrderCancelReplaceReject536Decoder sbeSkip()
    {
        sbeRewind();
