...
public final class RetransmitRequest508Encoder implements MessageEncoderFlyweight
{
    ...
    private final RetransmitRequest508Encoder parentMessage = this;
    ...
    public RetransmitRequest508Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public RetransmitRequest508Encoder wrapAndApplyHeader(
    ...
    public RetransmitRequest508Encoder uUID(final long value)
    {
    ...
    public RetransmitRequest508Encoder lastUUID(final long value)
    {
    ...
    public RetransmitRequest508Encoder requestTimestamp(final long value)
    {
    ...
    public RetransmitRequest508Encoder fromSeqNo(final long value)
    {
    ...
    public RetransmitRequest508Encoder msgCount(final int value)
    {
