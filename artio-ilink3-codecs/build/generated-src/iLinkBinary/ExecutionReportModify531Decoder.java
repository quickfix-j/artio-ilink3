...
public final class ExecutionReportModify531Decoder implements MessageDecoderFlyweight
{
    ...
    private final ExecutionReportModify531Decoder parentMessage = this;
    ...
    public ExecutionReportModify531Decoder wrap(
    ...
    public ExecutionReportModify531Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ExecutionReportModify531Decoder sbeRewind()
    {
    ...
    {
        return (buffer.getShort(offset + 195, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return buffer.getByte(offset + 197);
    }

    public OrderType ordType()
    {
        return OrderType.get(buffer.getByte(offset + 197));
    }
    ...
    public SideReq side()
    {
        return SideReq.get(((short)(buffer.getByte(offset + 198) & 0xFF)));
    }
    ...
    {
        return TimeInForce.get(((short)(buffer.getByte(offset + 199) & 0xFF)));
    }
    ...
    {
        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 200) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 201) & 0xFF));
    }

    public BooleanFlag possRetransFlag()
    {
        return BooleanFlag.get(((short)(buffer.getByte(offset + 201) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 202) & 0xFF));
    }

    public SplitMsg splitMsg()
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 202) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 205);
    }

    public ExecMode executionMode()
    {
        return ExecMode.get(buffer.getByte(offset + 205));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 206) & 0xFF));
    }

    public BooleanNULL liquidityFlag()
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 206) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 207) & 0xFF));
    }

    public BooleanNULL managedOrder()
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 207) & 0xFF)));
    }
    ...
    {
        return ((short)(buffer.getByte(offset + 208) & 0xFF));
    }

    public ShortSaleType shortSaleType()
    {
        return ShortSaleType.get(((short)(buffer.getByte(offset + 208) & 0xFF)));
    }
    ...
    public long delayToTime()
    {
        ...
        return buffer.getLong(offset + 209, BYTE_ORDER);
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ExecutionReportModify531](sbeTemplateId=");
    ...
    public ExecutionReportModify531Decoder sbeSkip()
    {
        sbeRewind();
