...
public final class RetransmitReject510Decoder implements MessageDecoderFlyweight
{
    ...
    private final RetransmitReject510Decoder parentMessage = this;
    ...
    public RetransmitReject510Decoder wrap(
    ...
    public RetransmitReject510Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RetransmitReject510Decoder sbeRewind()
    {
    ...
    {
        return (buffer.getShort(offset + 72, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return SplitMsg.get(((short)(buffer.getByte(offset + 74) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[RetransmitReject510](sbeTemplateId=");
    ...
    public RetransmitReject510Decoder sbeSkip()
    {
        sbeRewind();
