...
public final class RetransmitReject510Encoder implements MessageEncoderFlyweight
{
    public static final int BLOCK_LENGTH = 75;
    public static final int TEMPLATE_ID = 510;
    public static final int SCHEMA_ID = 8;
    public static final int SCHEMA_VERSION = 8;
    public static final String SEMANTIC_VERSION = "FIX5.0";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final RetransmitReject510Encoder parentMessage = this;
    ...
    public RetransmitReject510Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public RetransmitReject510Encoder wrapAndApplyHeader(
    ...
    public RetransmitReject510Encoder reason(final int index, final byte value)
    {
        if (index < 0 || index >= 48)
        {
    ...
    public RetransmitReject510Encoder putReason(final byte[] src, final int srcOffset)
    {
        final int length = 48;
    ...
    public RetransmitReject510Encoder reason(final String src)
    {
        final int length = 48;
    ...
    public RetransmitReject510Encoder reason(final CharSequence src)
    {
        final int length = 48;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public RetransmitReject510Encoder uUID(final long value)
    {
    ...
    public RetransmitReject510Encoder lastUUID(final long value)
    {
    ...
    public RetransmitReject510Encoder requestTimestamp(final long value)
    {
    ...
    public RetransmitReject510Encoder errorCodes(final int value)
    {
        buffer.putShort(offset + 72, (short)value, BYTE_ORDER);
        return this;
    }
    ...
    public RetransmitReject510Encoder splitMsg(final SplitMsg value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final RetransmitReject510Decoder decoder = new RetransmitReject510Decoder();
