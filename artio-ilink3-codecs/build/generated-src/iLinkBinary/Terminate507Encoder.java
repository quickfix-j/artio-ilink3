...
public final class Terminate507Encoder implements MessageEncoderFlyweight
{
    ...
    private final Terminate507Encoder parentMessage = this;
    ...
    public Terminate507Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public Terminate507Encoder wrapAndApplyHeader(
    ...
    public Terminate507Encoder reason(final int index, final byte value)
    {
        if (index < 0 || index >= 48)
        {
    ...
    public Terminate507Encoder putReason(final byte[] src, final int srcOffset)
    {
        final int length = 48;
    ...
    public Terminate507Encoder reason(final String src)
    {
        final int length = 48;
    ...
    public Terminate507Encoder reason(final CharSequence src)
    {
        final int length = 48;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public Terminate507Encoder uUID(final long value)
    {
    ...
    public Terminate507Encoder requestTimestamp(final long value)
    {
    ...
    public Terminate507Encoder errorCodes(final int value)
    {
    ...
    public Terminate507Encoder splitMsg(final SplitMsg value)
    {
