...
public final class ExecutionReportPendingCancel564Encoder implements MessageEncoderFlyweight
{
    public static final int BLOCK_LENGTH = 219;
    public static final int TEMPLATE_ID = 564;
    public static final int SCHEMA_ID = 8;
    public static final int SCHEMA_VERSION = 8;
    public static final String SEMANTIC_VERSION = "FIX5.0";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final ExecutionReportPendingCancel564Encoder parentMessage = this;
    ...
    public ExecutionReportPendingCancel564Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public ExecutionReportPendingCancel564Encoder wrapAndApplyHeader(
    ...
    public ExecutionReportPendingCancel564Encoder seqNum(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder uUID(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder execID(final int index, final byte value)
    {
        if (index < 0 || index >= 40)
        {
    ...
    public ExecutionReportPendingCancel564Encoder putExecID(final byte[] src, final int srcOffset)
    {
        final int length = 40;
    ...
    public ExecutionReportPendingCancel564Encoder execID(final String src)
    {
        final int length = 40;
    ...
    public ExecutionReportPendingCancel564Encoder execID(final CharSequence src)
    {
        final int length = 40;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder senderID(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public ExecutionReportPendingCancel564Encoder putSenderID(final byte[] src, final int srcOffset)
    {
        final int length = 20;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public ExecutionReportPendingCancel564Encoder senderID(final String src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder senderID(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder clOrdID(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public ExecutionReportPendingCancel564Encoder putClOrdID(final byte[] src, final int srcOffset)
    {
        final int length = 20;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public ExecutionReportPendingCancel564Encoder clOrdID(final String src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder clOrdID(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder partyDetailsListReqID(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder orderID(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder transactTime(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder sendingTimeEpoch(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder orderRequestID(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder location(final int index, final byte value)
    {
        if (index < 0 || index >= 5)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public ExecutionReportPendingCancel564Encoder putLocation(final byte[] src, final int srcOffset)
    {
        final int length = 5;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public ExecutionReportPendingCancel564Encoder location(final String src)
    {
        final int length = 5;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder location(final CharSequence src)
    {
        final int length = 5;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder securityID(final int value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder orderQty(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder cumQty(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder leavesQty(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder minQty(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder displayQty(final long value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder expireDate(final int value)
    {
    ...
    private static final byte[] ORDSTATUS_VALUE = { 54 };
    ...
    private static final byte[] EXECTYPE_VALUE = { 54 };
    ...
    public ExecutionReportPendingCancel564Encoder ordType(final OrderType value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder side(final SideReq value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder timeInForce(final TimeInForce value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder manualOrderIndicator(final ManualOrdIndReq value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder possRetransFlag(final BooleanFlag value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder splitMsg(final SplitMsg value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder liquidityFlag(final BooleanNULL value)
    {
    ...
    public ExecutionReportPendingCancel564Encoder delayToTime(final long value)
    {
        buffer.putLong(offset + 178, value, BYTE_ORDER);
        return this;
    }
    ...
    {
        discretionPrice.wrap(buffer, offset + 186);
    ...
    {
        reservationPrice.wrap(buffer, offset + 194);
    ...
    public ExecutionReportPendingCancel564Encoder priorityIndicator(final short value)
    {
        buffer.putByte(offset + 202, (byte)value);
        return this;
    }
    ...
    public ExecutionReportPendingCancel564Encoder origOrderUser(final int index, final byte value)
    {
        if (index < 0 || index >= 8)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
        ...
        final int pos = offset + 203 + (index * 1);
        buffer.putByte(pos, value);
    ...
    public ExecutionReportPendingCancel564Encoder putOrigOrderUser(final byte[] src, final int srcOffset)
    {
        final int length = 8;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
        ...
        buffer.putBytes(offset + 203, src, srcOffset, length);

        return this;
    }

    public ExecutionReportPendingCancel564Encoder origOrderUser(final String src)
    {
        final int length = 8;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
        ...
        buffer.putStringWithoutLengthAscii(offset + 203, src);

        for (int start = srcLength; start < length; ++start)
        {
            buffer.putByte(offset + 203 + start, (byte)0);
        }

        return this;
    }

    public ExecutionReportPendingCancel564Encoder origOrderUser(final CharSequence src)
    {
        final int length = 8;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public ExecutionReportPendingCancel564Encoder cancelText(final int index, final byte value)
    {
        if (index < 0 || index >= 8)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
        ...
        final int pos = offset + 211 + (index * 1);
        buffer.putByte(pos, value);
    ...
    public ExecutionReportPendingCancel564Encoder putCancelText(final byte[] src, final int srcOffset)
    {
        final int length = 8;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
        ...
        buffer.putBytes(offset + 211, src, srcOffset, length);

        return this;
    }

    public ExecutionReportPendingCancel564Encoder cancelText(final String src)
    {
        final int length = 8;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
        ...
        buffer.putStringWithoutLengthAscii(offset + 211, src);

        for (int start = srcLength; start < length; ++start)
        {
            buffer.putByte(offset + 211 + start, (byte)0);
        }

        return this;
    }

    public ExecutionReportPendingCancel564Encoder cancelText(final CharSequence src)
    {
        final int length = 8;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final ExecutionReportPendingCancel564Decoder decoder = new ExecutionReportPendingCancel564Decoder();
