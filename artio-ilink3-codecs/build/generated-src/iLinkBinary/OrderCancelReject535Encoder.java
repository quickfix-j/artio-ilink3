...
public final class OrderCancelReject535Encoder implements MessageEncoderFlyweight
{
    public static final int BLOCK_LENGTH = 409;
    public static final int TEMPLATE_ID = 535;
    public static final int SCHEMA_ID = 8;
    public static final int SCHEMA_VERSION = 8;
    public static final String SEMANTIC_VERSION = "FIX5.0";
    public static final java.nio.ByteOrder BYTE_ORDER = java.nio.ByteOrder.LITTLE_ENDIAN;

    private final OrderCancelReject535Encoder parentMessage = this;
    ...
    public OrderCancelReject535Encoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderCancelReject535Encoder wrapAndApplyHeader(
    ...
    public OrderCancelReject535Encoder seqNum(final long value)
    {
    ...
    public OrderCancelReject535Encoder uUID(final long value)
    {
    ...
    public OrderCancelReject535Encoder text(final int index, final byte value)
    {
    ...
    public OrderCancelReject535Encoder putText(final byte[] src, final int srcOffset)
    {
    ...
    public OrderCancelReject535Encoder text(final String src)
    {
        final int length = 256;
    ...
    public OrderCancelReject535Encoder text(final CharSequence src)
    {
        final int length = 256;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder execID(final int index, final byte value)
    {
        if (index < 0 || index >= 40)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public OrderCancelReject535Encoder putExecID(final byte[] src, final int srcOffset)
    {
        final int length = 40;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public OrderCancelReject535Encoder execID(final String src)
    {
        final int length = 40;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder execID(final CharSequence src)
    {
        final int length = 40;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder senderID(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public OrderCancelReject535Encoder putSenderID(final byte[] src, final int srcOffset)
    {
        final int length = 20;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public OrderCancelReject535Encoder senderID(final String src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder senderID(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder clOrdID(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public OrderCancelReject535Encoder putClOrdID(final byte[] src, final int srcOffset)
    {
        final int length = 20;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public OrderCancelReject535Encoder clOrdID(final String src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder clOrdID(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder partyDetailsListReqID(final long value)
    {
    ...
    private static final byte[] CXLREJRESPONSETO_VALUE = { 49 };
    ...
    public OrderCancelReject535Encoder orderID(final long value)
    {
    ...
    public OrderCancelReject535Encoder transactTime(final long value)
    {
    ...
    public OrderCancelReject535Encoder sendingTimeEpoch(final long value)
    {
    ...
    public OrderCancelReject535Encoder orderRequestID(final long value)
    {
    ...
    public OrderCancelReject535Encoder location(final int index, final byte value)
    {
        if (index < 0 || index >= 5)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public OrderCancelReject535Encoder putLocation(final byte[] src, final int srcOffset)
    {
        final int length = 5;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public OrderCancelReject535Encoder location(final String src)
    {
        final int length = 5;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder location(final CharSequence src)
    {
        final int length = 5;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderCancelReject535Encoder cxlRejReason(final int value)
    {
    ...
    public OrderCancelReject535Encoder delayDuration(final int value)
    {
    ...
    public OrderCancelReject535Encoder manualOrderIndicator(final ManualOrdIndReq value)
    {
    ...
    public OrderCancelReject535Encoder possRetransFlag(final BooleanFlag value)
    {
    ...
    public OrderCancelReject535Encoder splitMsg(final SplitMsg value)
    {
    ...
    public OrderCancelReject535Encoder liquidityFlag(final BooleanNULL value)
    {
    ...
    public OrderCancelReject535Encoder delayToTime(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderCancelReject535Decoder decoder = new OrderCancelReject535Decoder();
