...
public final class NewOrderSingle514Decoder implements MessageDecoderFlyweight
{
    ...
    private final NewOrderSingle514Decoder parentMessage = this;
    ...
    public NewOrderSingle514Decoder wrap(
    ...
    public NewOrderSingle514Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public NewOrderSingle514Decoder sbeRewind()
    {
    ...
    public String location()
    {
        ...
        buffer.getBytes(offset + 93, dst, 0, 5);
    ...
    public int getLocation(final Appendable value)
    {
        for (int i = 0; i < 5; ++i)
        {
            final int c = buffer.getByte(offset + 93 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    public long minQty()
    {
        return (buffer.getInt(offset + 98, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    {
        return (buffer.getInt(offset + 102, BYTE_ORDER) & 0xFFFF_FFFFL);
    }
    ...
    {
        return (buffer.getShort(offset + 106, BYTE_ORDER) & 0xFFFF);
    }
    ...
    {
        return buffer.getByte(offset + 108);
    }

    public OrderTypeReq ordType()
    {
        return OrderTypeReq.get(buffer.getByte(offset + 108));
    }
    ...
    {
        return TimeInForce.get(((short)(buffer.getByte(offset + 109) & 0xFF)));
    }
    ...
    {
        return ManualOrdIndReq.get(((short)(buffer.getByte(offset + 110) & 0xFF)));
    }
    ...
    {
        return buffer.getByte(offset + 112);
    }

    public ExecMode executionMode()
    {
        return ExecMode.get(buffer.getByte(offset + 112));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 113) & 0xFF)));
    }
    ...
    {
        return BooleanNULL.get(((short)(buffer.getByte(offset + 114) & 0xFF)));
    }
    ...
    {
        return ShortSaleType.get(((short)(buffer.getByte(offset + 115) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[NewOrderSingle514](sbeTemplateId=");
    ...
    public NewOrderSingle514Decoder sbeSkip()
    {
        sbeRewind();
